...
integer i,j, npts,NE,natoms,natoms_mg,natoms_si,natoms_n
real*8 m_mg,m_si,m_o,a1_mg,a2_mg,a1_si,a2_si,a1_o,a2_o,factrl_mg,factrl_si,factrl_o,m_n,factrl_n,a1_n,a2_n
...
do i = 1, natoms_n
 factrl_n=factrl_n*dfloat(i)
enddo 

!N
a1_n=0.001d0*vol/dfloat(natoms_n)
a2_n=2.0d0*pi*m_n*amu2Kg*k_B*T/(h**2)
a2_n=a2_n**(3.0d0/2.0d0)

a1=0.001d0*vol

F_id1=-k_B2*T*(dfloat(natoms_n)*log(a1*a2_n)-log(factrl_n)) 
F_id=(F_id1)/dfloat(natoms_n) !per atom (exact)

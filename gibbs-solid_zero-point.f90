...
real*8 k_B,h,T,P,dos,w_0,w_A,w_S,w_E,x,v,v1,v2,hv,kBT,n,Lx,Ly,Lz,E,E_0
real*8 dosXw_0(:),dosXw_A(:),dosXw_S(:),dosXw_E(:)
real*8 int_dosXw_0,int_dosXw_A,int_dosXw_S,int_dosXw_E
real*8 vol,q,enth,G,sum_0,sum_1,sum_2,sum_3,D
real*8 alat,ax,ay,az,bx,by,bz,cx,cy,cz
character*12 fdos, fpos
parameter (k_B=1.3806503E-23,h=6.626068E-34,q=1.60217646E-19)  
allocatable :: dosXw_0,dosXw_A,dosXw_S,dosXw_E
...
allocate(dosXw_0(npts),dosXw_A(npts),dosXw_S(npts),dosXw_E(npts))

#!/usr/bin/env python
"""
md-vasp_analyze.py VERSION 5.0
Author: Brian Boates

Run all applicable scripts to analyze a monatomic system
"""
...
def main():
    ...
    natom = int(commands.getoutput('grep -B1 Direct POSCAR | head -1'))
    ...
    # Nearest neighbor angles analysis
    print 'Calculating nearest neighbor angle distribution...'
    out = open('angle.in','w')
    ...
    out.write('y\n')
    out.close()
    os.system('nice -15 nn_angles.x < angle.in > angle.out')
    os.system('rm -f angle.in angle.out')
    print 'done'
    ...
    os.system('nice -15 correlators.py TRAJEC.cnn  9 '+var+' > cluster9.out')
    os.system('nice -15 correlators.py TRAJEC.cnn 10 '+var+' > cluster10.out')
    os.system('nice -15 correlators.py TRAJEC.cnn 11 '+var+' > cluster11.out')
    os.system('nice -15 correlators.py TRAJEC.cnn 12 '+var+' > cluster12.out')
    os.system('nice -15 correlators.py TRAJEC.cnn 13 '+var+' > cluster13.out')
    os.system('nice -15 correlators.py TRAJEC.cnn 14 '+var+' > cluster14.out')
    os.system('nice -15 correlators.py TRAJEC.cnn 15 '+var+' > cluster15.out')
    os.system('nice -15 correlators.py TRAJEC.cnn 16 '+var+' > cluster16.out')
    ...
    os.system('rm -f coord.in coord.out')
    print 'done'

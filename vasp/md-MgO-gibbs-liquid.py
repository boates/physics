#!/usr/bin/env python
"""
md-MgO-gibbs-liquid.py VERSION 1.0
Author: Brian Boates

compute Gibbs for MgO liquid
"""
...
def main():
    ...
    os.system("grep 'Entropy per atom in k_B'  entropy_Mg.out | grep -v id | awk '{print $6}' > S_Mg_in_kB") # in kB
    ...
    ######
    os.system("paste S_Mg S_O | awk '{print $1+$2}' > S")
    os.system("paste S_Mg_in_kB S_O_in_kB | awk '{print $1+$2}' > S_in_kB")
    ######
